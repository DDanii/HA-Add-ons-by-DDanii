# Home assistant app (add-on): 2FAuth
...
[2FAuth](https://docs.2fauth.app/) is a web app to manage your Two-Factor Authentication (2FA) accounts and generate their security codes
